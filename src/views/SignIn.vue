<template>
  <div class="h-screen flex">
    <div class="container h-full flex-shrink-0 hidden sm:flex flex-col bg-gray-700" style="width: 44%">
      <div class="h-24"></div>
      <div class="flex-grow pt-32 lg:pl-8">
        <img
          src="@/assets/img/cloud.svg"
          class="absolute pointer-events-none pt-32"
    ...
    <div class="container h-full flex-grow flex flex-col">
      <div class="h-24 flex items-center justify-end text-gray-200 lg:pr-20">
      ...
      <div class="w-full max-w-sm flex-grow mx-auto lg:ml-24 pt-32">
      ...
      <div class="h-24 flex items-center lg:ml-24">
        <Copyright class="mx-auto sm:mx-0" />
      </div>
    </div>
    <v-dialog
