...
export default {
  ...
  data () {
    return {
      headers: [
        { text: 'ID', value: 'id', bgcolor: 'tansparent', align: 'left' },
        { text: 'Name', value: 'name', bgcolor: 'tansparent', align: 'left' },
        { text: 'City/Country', value: 'location', bgcolor: 'tansparent', align: 'left' },
      ],
      items: [
