    ...
    <div class="pt-4 pb-10">
      ...
      <div class="overflow-x-auto overflow-scroll-touch pb-4">
        ...
        >
          ...
          <template v-slot:header.finalCost="{ header }">
            <td :width="header.width + 'px'">
          ...
          <template v-slot:items="{ items }">
            ...
            >
              ...
              <td class="truncate text-right pr-2">{{ $n(item.finalCost || 0) }}</td>
              <td class="truncate text-right text-gray-200 pl-2">{{ item.margin || 0 }}%</td>
              <td class="truncate pl-3">{{ item.client.fullName }}</td>
              <td class="truncate">{{ item.client.contactPerson }}</td>
              <td class="truncate">
                <span>
                  <v-tooltip top>
                    <template v-slot:activator="{ on }">
              ...
              <td class="truncate pointer-events-none" @click.stop>
                <span v-if="item.client.mobilePhone" class="pointer-events-auto">
                  <a
                    :href="`tel:${item.client.mobilePhone}`"
                  ...
                  <i class="zi-action text-2xl text-gray-200 align-middle ml-1" />
                </span>
              </td>
              <td class="truncate">{{ (item.client.uid) }}</td>
  ...
  computed: {
    ...
    headers () {
      return [
        ...
        { text: '', value: 'isMoneyRecieved', align: 'left', width: 48, sortable: false },
        { text: '', value: 'isExpensesPaid', align: 'left', width: 48, sortable: false },
        { text: '', value: 'finalCost', align: 'right', width: 105, sortable: true },
        { text: '', value: 'margin', align: 'right', width: 52, sortable: true },
        { text: this.$t('deals.clientName'), value: 'client.fullName', align: 'left', width: 210, minWidth: 210, class: 'whitespace-no-wrap text-left pl-3', sortable: true },
        { text: this.$t('deals.contactPerson'), value: 'client.contactPerson', align: 'left', width: 165, sortable: true },
        { text: this.$t('deals.number'), value: 'specNo', align: 'left', width: 60, minWidth: 60, class: 'whitespace-no-wrap', sortable: true },
        { text: this.$t('deals.createdAt'), value: 'createdAt', align: 'left', width: 110, minWidth: 110, class: 'whitespace-no-wrap pl-4 pr-3', sortable: true },
        { text: this.$t('deals.contact'), value: 'client.mobilePhone', align: 'left', width: 85, class: 'whitespace-no-wrap', sortable: true },
        { text: this.$t('deals.clientUcn'), value: 'client.uid', align: 'right', width: 65, class: 'whitespace-no-wrap', sortable: true },
        { text: '', value: 'actions', width: 45 },
        { text: '', value: 'isShipped', width: 32 },
