        ...
        >
          ...
          >
            <slot name="item" :item="item">
              <span>{{ item[itemText] || item[defaultItemText] }}</span>
            </slot>
          </li>
        </template>
        <li
    ...
    internalInput: {
      get () {
        ...
        if (isObject(this.value)) {
          v = this.value[this.itemText] || this.value[this.defaultItemText]
        } else {
          const item = this.items.find(el => el[this.itemValue] === this.value)
          v = item ? item[this.itemText] || this.item[this.defaultItemText] : ''
        }
    ...
    getSearchableInputText () {
      ...
      if (this.searchable) {
        if (isObject(this.value)) {
          ...
          const item = this.items.find(el => el[this.itemValue] === this.value)
          v = item ? item[this.itemText] || item[this.defaultItemText] : ''
        }
      }
      return v
    },
