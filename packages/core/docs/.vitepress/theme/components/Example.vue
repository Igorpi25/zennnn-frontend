...
const getCodesModules = () => {
  ...
  switch (page) {
    ...
    case 'Checkbox': return import.meta.globEager('../../../../playground/generated/code/Checkbox/*.vue')
    ...
    case 'Radio': return import.meta.globEager('../../../../playground/generated/code/Radio/*.vue')
    case 'Select': return import.meta.globEager('../../../../playground/generated/code/Select/*.vue')
    case 'Switch': return import.meta.globEager('../../../../playground/generated/code/Switch/*.vue')
...
function switchTab (tab: 1 | 2) {
  ...
  if (tab === TAB.CODE && !isCodeLoaded.value) {
    initialHeight.value = previewRef.value?.clientHeight || 80
  }
}
</script>
