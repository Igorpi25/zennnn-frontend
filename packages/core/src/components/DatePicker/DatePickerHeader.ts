...
export default defineComponent({
      ...
      return h(
        'button',
        {
          class: {
            ...
            'text-blue-500 hover:bg-blue-400 hover:text-white focus:bg-blue-400 focus:text-white focus:outline-none':
              true,
          },
    ...
    const genTitle = () => {
      return h(
        props.clickable ? 'button' : 'span',
        {
          class: {
            'px-4': true,
            'text-blue-500 hover:text-blue-400 focus:text-blue-400 focus:outline-none transition':
              props.clickable,
          },
          onClick: (e: MouseEvent) => {
            e.preventDefault()
  ...
  render() {
    return h(
      ...
      [this.genPrevButton(), this.genTitle(), this.genNextButton()]
    )
  },
})
