    ...
    >
      ...
      <tbody class="text-gray-300 leading-5">
        <tr v-for="(item, i) of products" :key="item.id">
          ...
          <td class="bg-white py-2 pl-2 pr-1 text-right">
            {{ $n(item.qty || 0) }}
          </td>
      ...
      <tfoot>
        <tr class="text-sm">
          ...
          <td colspan="4" class="py-2 pl-5 text-gray-100">
            ...
            <div class="h-6">
              {{
                invoice.prepaymentDate
                  ? $d($parseDate(invoice.prepaymentDate), 'short')
                  : '--.--.--'
              }}
            </div>
            <div class="h-6">
              {{
                invoice.clientDebtDate
                  ? $d($parseDate(invoice.clientDebtDate), 'short')
                  : '--.--.--'
              }}
            </div>
          </td>
...
export default {
  ...
  computed: {
    ...
    headers() {
      return [
        {
          text: this.$t('paper.itemNo'),
          value: 'number',
          align: 'center',
          width: 48,
        },
        {
          text: this.$t('paper.photo'),
          value: 'photo',
          align: 'left',
          width: 58,
        },
        {
          text: this.$t('paper.name'),
          value: 'name',
          align: 'left',
          width: 250,
        },
        {
          text: this.$t('paper.status'),
          value: 'status',
          align: 'left',
          width: 120,
        },
        {
          text: `${this.$t('paper.price')}(${this.$t(
        ...
        {
          text: this.$t('paper.unit'),
          value: 'unit',
          align: 'left',
          width: 60,
        },
        {
          text: `${this.$t('paper.cost')}(${this.$t(
            `currency.${this.currency}.symbol`
          )})`,
          value: 'cost',
          align: 'right',
        ...
        {
          text: this.$t('paper.qtyOfPackages'),
          value: 'pkgQty',
          align: 'right',
          width: 70,
        },
        {
          text: this.$t('paper.packageNo'),
          value: 'pkgNo',
          align: 'right',
          width: 70,
        },
        {
          text: this.$t('paper.notes'),
          value: 'note',
          align: 'left',
          width: 66,
        },
