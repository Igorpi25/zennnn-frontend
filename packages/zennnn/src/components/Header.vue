    ...
    <div class="container">
      <div :class="[light ? 'h-20' : 'h-14', 'flex']">
        ...
        <div class="flex items-center">
          <router-link to="/" :class="[light ? 'text-gray-900' : 'text-gray-100']">
            ...
            >
              <template v-slot:activator>
                ...
                >
                  ...
                  >
                    <div
                      :class="[light ? 'text-gray-900' : 'text-white', 'leading-4 truncate']"
                    >
                      {{ currentOrg.name }}
                    </div>
                    <div
                      :class="[light ? 'text-gray-200' : 'text-gray-100', 'text-xs leading-none']"
                    >
                      {{ currentOrg.role ? $t(`header.role.${currentOrg.role}`) : '' }}
                    </div>
                  </div>
                  <div :class="[light ? 'text-gray-200' : 'text-gray-100', 'avatar']">
                    <img
...
import { Image, LoadingSpinner, Btn, Icon, Menu, MenuItem, Modal } from '@zennnn/core'
