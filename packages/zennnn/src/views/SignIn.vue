<template>
  <div class="flex-grow flex">
    ...
    >
      <div class="signin--top flex-grow lg:pl-8">
        ...
        <div class="pt-1 lg:pl-12">
          ...
          />
          <h3
            class="text-2xl text-gray-200 leading-relaxed"
    ...
    <Modal v-model="compliteFormDialog" max-width="385" persistent>
      <Form
        ref="compliteForm"
      ...
      >
        ...
        >
          <template v-slot:append>
            <Icon
              class="text-gray-500 hover:text-gray-300 pr-1"
              @click.prevent="compliteShowPassword = !compliteShowPassword"
            >
              {{ compliteShowPassword ? icons.ziVisible : icons.ziHide }}
            </Icon>
          </template>
        </TextField>
        <Checkbox :rules="[rules.check]" :hide-details="false" class="pb-6">
...
export default {
  ...
  computed: {
    policyHtml() {
      ...
      )}&nbsp;<a class="text-blue-500 hover:text-blue-400 focus:text-blue-400 focus:outline-none" href="#">
        ${this.$t('signup.privacyPolicy')}</a> ${this.$t(
        'preposition.and'
      )}&nbsp;<a class="text-blue-500 hover:text-blue-400 focus:text-blue-400 focus:outline-none" href="#">${this.$t(
        'signup.termsOfUse'
      )}</a>`
    },
  },
