      ...
      >
          ...
          <Tooltip top max-width="162">
            <template v-slot:activator>
              <span>
                ...
                <Icon class="align-middle text-blue-500">{{
        ...
        <template v-slot:items="{ items }">
          <template v-for="item in items">
            ...
            <tr v-else :key="item.id" class="cursor-default" tabindex="0">
              <td></td>
