<template>
  ...
  <div class="font-montserrat">
      ...
      <header class="pt-6 pb-4 font-medium">
        <div class="container">
          <div class="flex items-center h-13">
            <router-link :to="{ name: 'home' }" class="h-6 mr-16">
              <img src="@/assets/img/logo-light.svg" alt="Logo" />
            </router-link>
            <nav
              class="hidden md:flex items-center leading-5 text-light-gray-700"
            >
              <a
            ...
            <router-link
              ...
              class="
                ...
                select-none
                focus:outline-none
                focus:text-cold-blue-600
                hover:text-cold-blue-600
              "
            >
            ...
            <div class="relative">
              ...
              >
                <img
                  ...
                  alt="info"
                  class="flex-shrink-0 self-start mr-4"
                />
                <div
                  v-html="
                    'ZENNNN — самый удобный сервис для удаленной работы с&nbsp;поставщиками со&nbsp;всего мира.'
                  "
                ...
                >
                  ...
                  >
                    <path
                      d="M1.46451 0.657227L9.94979 9.14251L8.53557 10.5567L0.0502933 2.07144L1.46451 0.657227Z"
                      fill="currentColor"
                    />
                    <path
                      d="M9.94979 2.07144L1.46451 10.5567L0.050293 9.14251L8.53557 0.657227L9.94979 2.07144Z"
                      fill="currentColor"
                    />
                  </svg>
                </div>
          ...
          >
            <div class="w-full lg:w-1/2 lg:w-1/4 flex flex-col lg:pr-4">
              <div class="flex-grow flex mb-2 lg:mb-0">
                ...
                <span
                  v-html="
                    'Удаленная работа с&nbsp;кли&shy;ен&shy;та&shy;ми и&nbsp;пос&shy;тав&shy;щи&shy;ка&shy;ми'
                  "
                />
              </div>
              <div class="flex mb-2">
            ...
            <div class="w-full md:w-1/2 pb-4 md:pb-0 text-center md:text-left">
              <router-link
                ...
                class="
                  ...
                  select-none
                  focus:outline-none
                  focus:bg-cold-blue-600
                  hover:bg-cold-blue-600
                "
                style="height: 62px"
              >
    ...
    <main>
      ...
      <div id="video">
        <h3
          class="about-section-title font-bold text-center mx-auto mt-10"
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <path
                        d="M86.0371 57.4298C88.0371 58.5845 88.0371 61.4712 86.0371 62.6259L50.0371 83.4105C48.0371 84.5652 45.5371 83.1218 45.5371 80.8124L45.5371 39.2432C45.5371 36.9338 48.0371 35.4904 50.0371 36.6451L86.0371 57.4298Z"
                        fill="white"
                      />
                    </svg>
                  </div>
      ...
      <div id="feature" class="about-section-bg relative pt-24">
        <div>
          <div class="container flex w-full overflow-x-auto mb-8">
            ...
            >
              <div
                class="absolute bottom-0 inset-x-0 h-px bg-light-gray-600 mx-5"
              />
              <a
          ...
          <div>
            ...
            <div
              class="absolute inset-x bottom-0 w-full flex justify-center pb-24"
            >
      ...
      <div class="about-section-bg relative pt-24">
        <div class="pb-10">
          ...
          <div
            class="absolute inset-x bottom-0 w-full flex justify-center pb-32"
          >
            <div class="flex justify-center">
              <div
      ...
      <div class="container py-24">
        <div class="flex flex-col xl:flex-row py-1">
          ...
          <div class="order-first xl:order-none flex-grow h-0 relative">
            ...
            >
              <img
                src="@/assets/img/currency-usd.svg"
                alt="currency"
        ...
        <div class="container flex pt-32 pb-10 lg:mt-6">
          <div class="w-full flex-shrink-0" style="max-width: 518px">
            ...
            <div class="text-lg leading-relaxed text-light-gray-900">
              ...
              все процессы, с ним связанные, — в течение сделки кабинет клиента
              хранит информацию о сроках оплаты и доставки, показывает статус
              товара, позволяет комментировать работу менеджеров, загружать
              фотографии товара и распечатывать все необходимые документы
              самостоятельно.
            </div>
          </div>
      ...
      <div class="relative" style="top: -88px">
        <div class="container">
          ...
          >
            ...
            >
              Бесплатный пробный доступ предоставляется на 7 дней. Этого времени
              хватит, чтобы оценить удобство сервиса и навсегда полюбить ZENNNN.
            </div>
            <div
              v-html="
                'Первой 1&nbsp;000 пользователей подарим доступ на&nbsp;1&nbsp;месяц'
              "
        ...
        <div class="w-full lg:w-1/2 xl:-ml-10 xl:mr-10 pb-16 lg:pb-0">
          ...
          >
            ...
            <div class="absolute right-0" style="width: 240px">
              <div
                class="absolute"
                style="bottom: -60px; right: 0; width: 140px; z-index: -1"
              >
                <img src="@/assets/img/cog.svg" alt="cog" />
              </div>
              <Image
      ...
      <div id="review" class="py-32 bg-gray-900">
        <div class="container flex flex-col md:flex-row relative py-5">
          ...
          <div class="flex-grow">
            <Window v-model="activeReview" ref="reviewWindow" continuous>
              <WindowItem
            ...
            <div class="flex flex-wrap -mb-4">
              ...
              >
                ...
                >
                  <img
                    :src="
                      require(`@/assets/img/flags/rounded/${member.country}.svg`)
                        .default
                    "
                    :alt="member.country"
      ...
      <div class="bg-gray-900 py-20">
        <div class="container pt-5 pb-sm">
          <div class="flex flex-col items-center text-center">
            ...
            >
              <span class="px-1">
                Получить доступ в систему<br />на
    ...
    <footer class="about-footer text-black leading-6 py-6">
      <div class="text-center py-1 px-4">
        <span class="inline-block sm:inline"
          >Copyright © 2015-2019 ZENNNN.</span
        >
    ...
    return {
      ...
      team: [
        ...
        },
        {
          name: 'Игорь Иванов',
          position:
            'CTO, программист, сооснователь ZENNNN, бэк-энд разработчик',
          country: 'RU',
        },
        {
          name: 'Анна Маловичко',
    ...
    goTo(index) {
      ...
      if (id) {
        ...
        if (nav.sectionId === 'video') {
          const h =
            (this.$refs.infoAlertContent &&
              this.$refs.infoAlertContent.offsetHeight) ||
            0
