<template>
  ...
  <div class="flex-grow flex flex-col">
    <!-- / HEADER -->
    <Header v-if="isLoggedIn" :org="orgId" light>
    ...
    <main class="container flex-grow pt-16">
      ...
      <div class="pb-20">
        <PriceList :is-logged-in="isLoggedIn" :org-id="orgId" />
      </div>
      <div class="pb-20">
        ...
        <div class="overflow-x-auto scrolling-touch">
          <table
            width="100%"
            class="w-full leading-tight text-gray-900 text-center"
          >
            <thead>
