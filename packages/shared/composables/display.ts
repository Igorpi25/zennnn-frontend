import { inject, reactive, ref, toRefs, watchEffect, ToRefs } from 'vue'
...
export const DisplaySymbol: InjectionKey<ToRefs<DisplayInstance>> =
  Symbol.for('app:display')
...
export function createDisplay(): ToRefs<DisplayInstance> {
  const { thresholds, mobileBreakpoint } =
    defaultDisplayOptions as InternalDisplayOptions
